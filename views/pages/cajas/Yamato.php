...
<div id="content">
    <div class="producto">
        ...
        <div class="selecionables">
            <img src="../../assets/Productos/YamatoCage/preview.jpg" alt="" class="selector">
            <img src="../../assets/Productos/YamatoCage/front.jpg" alt="" class="selector">
            <img src="../../assets/Productos/YamatoCage/lateral1.jpg" alt="" class="selector">
            <img src="../../assets/Productos/YamatoCage/lateral2.jpg" alt="" class="selector">
            <img src="../../assets/Productos/YamatoCage/open.jpg" alt="" class="selector">
            <img src="../../assets/Productos/YamatoCage/back.jpg" alt="" class="selector">
        </div>
        
            <div class="imagenpreview">
            <img src="../../assets/Productos/YamatoCage/preview.jpg" alt="" id="preview">
        </div>
          </div>
          <div class="datos">
            <h1 class="nombre">Caja de Yamato para juego de cartas de One Piece</h1>
            ...
            <p>Caja para el almacenamiento del deck de cartas de One Piece con la tematica de Yamato</p>
        </div>
    </div>
