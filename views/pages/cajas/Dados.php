...
<div id="content">
    <div class="producto">
        ...
        <div class="selecionables">
            <img src="../../assets/Productos/CajaDados/preview.jpg" alt="" class="selector">
            <img src="../../assets/Productos/CajaDados/preview2.jpg" alt="" class="selector">
            <img src="../../assets/Productos/CajaDados/preview3.jpg" alt="" class="selector">

        </div>
        
            <div class="imagenpreview">
            <img src="../../assets/Productos/CajaDados/preview.jpg" alt="" id="preview">
        </div>
          </div>
          <div class="datos">
